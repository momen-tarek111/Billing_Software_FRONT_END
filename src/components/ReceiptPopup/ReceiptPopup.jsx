         ...
         <div className="receipt-popup">
            ...
            </p>
            {
                orderDetails.paymentMethod==="CARD"&&(
                    <>
                        <p>
                            <strong>Payment ID:</strong>{orderDetails.paymentDetails.paymentIntentId}
                        </p>
                        <p>
                            <strong>Payment status: </strong>{orderDetails.paymentDetails.status.toUpperCase()}
                        </p>
                    </>
                )
            }
            <div className="d-flex justify-content-end gap-3 mt-4">
                <button onClick={onPrint} className="btn btn-warning">Print Receipt</button>
